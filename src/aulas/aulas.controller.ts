...
export class AulasController {
  ...
  @ApiParam({
    type: 'string',
    name: 'aulaID',
    description: 'ID del aula que se quiere encontrar',
  })
  ...
  @ApiParam({
    type: 'string',
    name: 'aulaID',
    description: 'ID del aula que se quiere eliminar',
  })
  ...
  @ApiParam({
    type: 'string',
    name: 'aulaID',
    description: 'ID del aula que se quiere modificar',
  })
