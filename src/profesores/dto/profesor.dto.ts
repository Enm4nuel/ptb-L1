...
export class ProfesorDto {
    ...
    edad: number;
    @ApiProperty({type: Boolean, description: "Si el profesor esta vigente o no"})
    activo: boolean;
    @ApiProperty({
        type: Object, 
    ...
    @ApiProperty({type: Date, description: "fecha de la creacion de este documento"})
    createdAt: Date;
    @ApiProperty({type: Date, description: "fecha de eliminacion de este documento"})
    eliminatedAt: Date;
}