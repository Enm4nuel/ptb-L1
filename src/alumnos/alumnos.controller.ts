...
export class AlumnosController {
  ...
  @ApiParam({
    type: 'string',
    name: 'alumnoID',
    description: 'ID del alumno que se quiere encontrar',
  })
  ...
  @ApiParam({
    type: 'string',
    name: 'alumnoID',
    description: 'ID del alumno que se quiere eliminar',
  })
  ...
  @ApiParam({
    type: 'string',
    name: 'alumnoID',
    description: 'ID del alumno que se quiere modificar',
  })
  ...
  async updateAlumnos(
    @Res() res,
    @Param('alumnoID') alumnoID,
    @Body() alumnosDto: AlumnosDto,
  ) {
    try {
      const alumno = await this.alumnoService.updateAlumnos(
        alumnoID,
        alumnosDto,
      );
      return res.status(HttpStatus.OK).json(alumno);
